...
if __name__ == "__main__":
    ...
    if os.path.isdir("./HerlockUserbot/"):
        rm_r("./HerlockUserbot/")
    repo = Repo.clone_from("https://github.com/SakirBey1/HerlockUserbot","./HerlockUserbot/", branch="main")
    ...
    config['DEFAULT_BIO'] = "@NoxusUserBot"
    ...
    config['TZ'] = TZ
    config['TZ_NUMBER'] = "1"
    config['UPSTREAM_REPO_URL'] = "https://github.com/frozenbey/noxususerbot"
    config['WARN_LIMIT'] = "3"
